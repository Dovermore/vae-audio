...
class SpecVaeTrainer(BaseTrainer):
    ...
    def _forward_and_computeLoss(self, x, target):
        ...
        loss = self.loss(x_recon, target, mu, logvar)
        return loss
...
#        loss = self.loss(x_recon, target, logLogit_qy_x, qy_x, q_mu, q_logvar,
#                         self.model.mu_lookup, self.model.logvar_lookup, self.model.n_component)
#        return loss
#
#    def _train_epoch(self, epoch):
#        """
